...
class Block(PandasObject):
    ...
    def apply(self, func, **kwargs) -> List["Block"]:
        ...
        one
        """
        kwargs = self._ensure_same_dim_values(kwargs)
