...
class TestDatetime64:
    def test_datetimeindex_fields(self):
    ...
    def test_datetimeindex_quarter_year_start_end(self):
    ...
    def test_datetimeindex_is_month_start_with_custom_business_day(self):
    ...
    def test_datetimeindex_is_month_start(self):
        dti = DatetimeIndex(["2000-01-01", "2000-01-02", "2000-01-03"])

        assert dti.is_month_start[0] == 1

    def test_datetimeindex_weekofyear(self):
    ...
    def test_day_name_month_name_locale(self, time_locale):
